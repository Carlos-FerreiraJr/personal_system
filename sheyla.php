...
<div class="col-md-6">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          <form role="form" lpformnum="1" method="POST" name="form1" action="https://menu.com.vc/sheyla.php">
                <div class="box-body">
		...
		<br>
                <div class="box-footer">
                    <button id ="gol"  name ="enviar" type="submit" class="btn btn-primary">Download</button>
                </div>
            </form>
        </div>
    </div>
